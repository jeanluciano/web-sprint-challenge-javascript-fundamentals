...
// because when a function doesn't find a variable inside of itslef it looks into the parent scope for it.
...
const zooAnimals = [
  ...
  */
  function lowerCaseNames(names){
    return names.map((animal) =>  animal.animal_name.toLowerCase())
  }
